...
function sumArray(array) {
  ...
  let sum = 0;
  // Проходимося по всіх індексах масиву
  for (const pointIndex in array) {
    //console.log(array[pointIndex]); //показати кожен елемент, який відноситься до свого індексу в масиві

    // Додаємо кожен елемент до загальної суми
    sum = sum + array[pointIndex];
  }
...
function concatenateStrings(array, subString) {
  ...
  for (const element of array) {
    if (element.toString() == subString) {
      console.log(true); // Виводимо результат
    }
  }
}
...
function multiplyByIndex(arr) {
  ...
  for (let i = 0; i < arr.length; ++i) {
    // Помножуємо число на його індекс і додаємо до масиву
    let num = arr[i] * i;
    array.push(num);
  }
  // Повертаємо масив результату
